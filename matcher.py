...
cursor.execute("create table ssa_unmatched (like tb_school INCLUDING ALL);")
cursor.execute("ALTER TABLE ssa_unmatched ADD coord geometry;")
cursor.execute("ALTER TABLE ssa_unmatched ALTER coord SET NOT NULL;")
cursor.execute("ALTER TABLE ssa_unmatched ADD code bigint;")
cursor.execute("ALTER TABLE ssa_unmatched ALTER code TYPE varchar(14);")
